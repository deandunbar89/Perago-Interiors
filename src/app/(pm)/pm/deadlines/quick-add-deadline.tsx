...
import type { PmProject } from "@prisma/client";
import { Plus } from "lucide-react";
import { createDeadline } from "@/lib/actions/pm-deadlines";

export default function QuickAddDeadline({ projects }: { projects: PmProject[] }) {
