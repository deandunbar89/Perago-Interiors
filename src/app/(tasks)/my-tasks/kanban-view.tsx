...
import { updateTaskDueDate } from "@/lib/actions/my-tasks";
import type { UnifiedTaskRow } from "./types";

export default function KanbanView({ tasks }: { tasks: UnifiedTaskRow[] }) {
  ...
  const columns = useMemo(() => {
    const map = Object.fromEntries(BUCKETS.map((b) => [b, [] as UnifiedTaskRow[]])) as Record<
      Bucket,
      UnifiedTaskRow[]
    >;
