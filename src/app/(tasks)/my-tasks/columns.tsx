...
function sortValue(col: ColumnId, task: UnifiedTaskRow): string | number | null {
  ...
  switch (col) {
    ...
    case "project":
      return project?.title?.toLowerCase() ?? null;
    case "status":
      return task.status;
    case "dueDate":
...
export function sortTasks(tasks: UnifiedTaskRow[], sort: SortState | null): UnifiedTaskRow[] {
